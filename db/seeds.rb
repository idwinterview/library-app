...
harry_potter = PhysicalBook.create(isbn: '0439708184', title: "Harry Potter and the Sorcerer's Stone",
                                   author: 'J.K. Rowling', category: 'fantasy')

CustomerBook.create(user_id: mrs_incredible.id, book_id: rails.id)
CustomerBook.create(user_id: mr_incredible.id, book_id: javascript.id)
CustomerBook.create(user_id: mr_incredible.id, book_id: harry_potter.id)
